...
public class GreedyWithSharingPreserveNextServicePoint implements OnlinePlanner {

	public PrintWriter log = null;
	public SimulatorBookedRequests sim = null;
	public GreedyWithSharingPreserveNextServicePoint(SimulatorBookedRequests sim){
		this.sim = sim;
		this.log = sim.log;
	}
