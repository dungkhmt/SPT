...
public class SequenceDecidedBasedOnAPopularPointPlanner implements OnlinePlanner {
	...
	public SequenceDecidedBasedOnAPopularPointPlanner(SimulatorTimeUnit sim) {
		this.sim = sim;
		this.log = sim.log;
	...
	public String name() {
		return "SequenceDecidedBasedOnAPopularPointPlanner";
	}
