...
public class GreedySharingNoExchangeDecisionTimeLimitPlanner implements OnlinePlanner{
	...
	public GreedySharingNoExchangeDecisionTimeLimitPlanner(SimulatorTimeUnit sim){
		this.sim = sim;
	...
	public String name(){ return "GreedySharingNoExchangeDecisionTimeLimit";}
