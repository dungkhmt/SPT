...
public class ParcelInsertionBasedOnASequencePopularPointsAfterGetManyTimes implements OnlineParcelInsertion {
	public SimulatorTimeUnit sim;
	public PrintWriter log;
	
	public ParcelInsertionBasedOnASequencePopularPointsAfterGetManyTimes(SimulatorTimeUnit sim){
		this.sim = sim;
		this.log = sim.log;
	}
	public String name(){
		return "ParcelInsertionBasedOnASequencePopularPointsAfterGetManyTimes";
	}
	...
	public ItineraryServiceSequence computeItineraryParcelInsertion(
		...
		//[SonNV]Establish itinerary based on sequence ss and a sequence popular points.
