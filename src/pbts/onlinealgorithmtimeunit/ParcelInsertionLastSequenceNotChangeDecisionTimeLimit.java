...
public class ParcelInsertionLastSequenceNotChangeDecisionTimeLimit implements
		OnlineParcelInsertion {
	public SimulatorTimeUnit sim;
	public PrintWriter log;
	
	public ParcelInsertionLastSequenceNotChangeDecisionTimeLimit(SimulatorTimeUnit sim){
		this.sim = sim;
		this.log = sim.log;
