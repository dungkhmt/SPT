...
public class GreedyExSharingDecisionTimeLimitAndBestParkingPlanner implements OnlinePlanner {
	...
	public GreedyExSharingDecisionTimeLimitAndBestParkingPlanner(SimulatorTimeUnit sim){
		this.sim = sim;
		if(sim != null)this.log = sim.log;
		peopleInserter = new PeopleInsertionGreedySharingDecisionTimeLimitAndComeBackBestParking(sim);
		parcelInserter = new ParcelInsertionGreedySharingDecisionTimeLimitAndComeBackBestParking(sim);
	...
	public String name(){ return "GreedyExSharingDecisionTimeLimitAndBestParkingPlanner";}
