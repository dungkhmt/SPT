...
public class GreedyExSharingDecisionTimeLimitAndAddAPopularPointBasedOnBestScoreOfParkingPlanner implements OnlinePlanner {
	...
	public GreedyExSharingDecisionTimeLimitAndAddAPopularPointBasedOnBestScoreOfParkingPlanner(SimulatorTimeUnit sim){
		this.sim = sim;
		if(sim != null)this.log = sim.log;
		peopleInserter = new PeopleInsertionGreedySharingDecisionTimeLimitGetManyTimesAndAddAPopularPoint(sim);
		parcelInserter = new ParcelInsertionGreedySharingDecisionTimeLimitAndGetManyTimesAddAPopularPoint(sim);
	...
	public String name(){ return "GreedyExSharingDecisionTimeLimitAndAddAPopularPointBasedOnBestScoreOfParkingPlanner";}
